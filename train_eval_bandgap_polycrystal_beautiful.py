# src/train_eval_bandgap_polycrystal_beautiful.py
import torch
...
def bandgap_polycrystal_plot(model_class, df, graphs, model_name="GCN",
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"results/{model_name}_bandgap_polycrystal_beautiful.png", dpi=1200, bbox_inches="tight")
    plt.close()
